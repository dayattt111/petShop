...
<head>
    ...
    <title>Hapus Layanan Perawatan</title>
    <style>
        ...
        .btn-delete-confirm:hover, .btn-cancel:hover { opacity: 0.9; }
    </style>
</head>
<body>
    <div class="wrapper">
        ...
        <div class="main-container">
            ...
            <div class="content">
                <h2 style="margin-top: 0; text-align: center;">🗑️ Konfirmasi Penghapusan Layanan</h2>
                
                <div class="confirmation-area">
                    <h3>PERINGATAN! Hapus Data Layanan</h3>
                    <p>Anda akan menghapus data layanan berikut dari daftar. Aksi ini tidak dapat dibatalkan!</p>
                    
                    <div class="detail-info">
                        <strong>ID Layanan:</strong> LYN-001<br>
                        <strong>Nama Layanan:</strong> Grooming Kucing<br>
                        <strong>Harga:</strong> Rp 120.000<br>
                        <strong>Dokter PJ:</strong> Dr. Budi
                    </div>

                    <form action="/Admin/KelolaLaporanDataLayananPerawatan" method="POST">
                        {{-- <input type="hidden" name="_token" value="SIMULASI_CSRF_TOKEN"> 
                        <input type="hidden" name="id_layanan" value="LYN-001"> --}}
                        @csrf
                        <div class="delete-actions">
                            <button type="submit" class="btn-delete-confirm">Ya, Hapus Layanan Ini</button>
                            <a href="/Admin/KelolaLaporanDataLayananPerawatan" class="btn-cancel">Batal / Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
