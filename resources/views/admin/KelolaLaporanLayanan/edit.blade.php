...
<body>
    <div class="wrapper">
        ...
        <div class="main-container">
            ...
            <div class="content">
                <h2 style="margin-top: 0; text-align: center;">✏️ Edit Layanan Perawatan (ID: LYN-001)</h2>
                ...
                <div class="form-area">
                    <form action="/Admin/KelolaLaporanDataLayananPerawatan" method="POST">
                        ...
                        <div class="form-group">
                            <label for="id_layanan_display">ID Layanan</label>
                            <input type="text" id="id_layanan_display" value="LYN-001" disabled>
                        </div>
                        <div class="form-group">
                            <label for="nama_layanan">Nama Layanan</label>
                            <input type="text" id="nama_layanan" value="Grooming Kucing" >
                        </div>
                        <div class="form-group">
                            <label for="harga">Harga (Rp)</label>
                            <input type="number" id="harga" value="120000" >
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <textarea id="deskripsi" rows="3">Layanan perawatan dasar untuk kucing, termasuk mandi, potong kuku, dan bersihkan telinga.</textarea>
                        </div>

                        <div class="form-actions">
                            <a href="/Admin/KelolaLaporanDataLayananPerawatan" class="btn-cancel">Batal</a>
                            <button type="submit" class="btn-submit">Perbarui Layanan</button>
                        </div>
                    </form>
                </div>
            </div>
