...
<head>
    ...
    <title>Tambah Data Produk Admin</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="main-container">
            ...
            <div class="content">
                <h2 style="margin-top: 0; text-align: center;">➕ Tambah Data Produk Baru</h2>
                ...
                <div class="form-area">
                    <form action="/Admin/KelolaDataProduk" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama" placeholder="Contoh: Makanan Anjing Premium" >
                        </div>
                        <div class="form-group">
                            <label for="kategori">Kategori</label>
                            <select id="kategori" >
                                <option value="">Pilih Kategori</option>
                                <option>Makanan Hewan</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="harga" placeholder="Contoh: 150000" min="0" >
                        </div>
                        <div class="form-group">
                            <label for="stok">Stok Awal</label>
                            <input type="number" id="stok" placeholder="Contoh: 50" min="0" >
                        </div>
                        <div class="form-group">
                            <label for="deskripsi">Deskripsi</label>
                            <textarea id="deskripsi" rows="3" placeholder="Deskripsi singkat produk..."></textarea>
                        </div>
