...
<head>
    ...
    <title>Hapus Data Produk Admin</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="main-container">
            ...
            <div class="content">
                <h2 style="margin-top: 0; text-align: center;">🗑️ Konfirmasi Penghapusan Produk</h2>
                
                <div class="confirmation-area">
                    <h3>PERINGATAN! Hapus Produk</h3>
                    <p>Anda yakin ingin menghapus produk **Makanan Anjing Premium (PROD-001)**? Aksi ini tidak dapat dibatalkan!</p>
                    ...
                    <form action="/Admin/KelolaDataProduk" method="POST">
                        ...
                        <div class="delete-actions">
                            <button type="submit" class="btn-delete-confirm">Ya, Hapus Produk Ini</button>
                            <a href="/Admin/KelolaDataProduk" class="btn-cancel">Batal / Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
