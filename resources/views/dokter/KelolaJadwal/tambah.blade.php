...
<body>
    <div class="wrapper">
        ...
        <div class="main-container">
            ...
            <div class="content">
                <h2 style="margin-top: 0; text-align: center;">➕ Tambah Jadwal Pemeriksaan/Perawatan</h2>
                ...
                <div class="form-area">
                    <form action="/Dokter/KelolaJadwal" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_user" placeholder="Masukkan nama user...">
                        </div>
                        <div class="form-group">
                            <label for="tanggal">Tanggal Jadwal</label>
                            <input type="date" id="tanggal" value="2025-11-21">
                        </div>
                        <div class="form-group">
                            <label for="waktu">Waktu Jadwal</label>
                            <input type="time" id="waktu" value="11:00">
                        </div>
                        <div class="form-group">
                            <label for="keluhan">Keluhan / Jenis Layanan</label>
                            <textarea id="keluhan" rows="3" placeholder="Masukkan keluhan pasien atau jenis layanan yang dipesan..."></textarea>
                        </div>
                        <div class="form-group">
