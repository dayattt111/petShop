...
<head>
    ...
    <title>Edit Data Transaksi Penjualan</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="main-container">
            ...
            <div class="content">
                <h2 style="text-align: center;">Edit Data Transaksi Penjualan (ID: TRX-001)</h2>
                ...
                <div class="form-area">
                    <form action="/Kasir/KelolaTransaksiPenjualan/edit" method="GET"> 
