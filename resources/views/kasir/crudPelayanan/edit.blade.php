...
<head>
    ...
    <title>Edit Data Transaksi Pelayanan</title>
    <style>
        ...
        .page-description { margin-bottom: 20px; padding: 10px; background-color: #fff3e0; border: 1px solid #ffcc80; border-radius: 4px; }
    </style>
</head>
<body>
    <div class="wrapper">
        ...
        <div class="main-container">
            ...
            <div class="content">
                <h2 style="text-align: center;">Edit Data Transaksi Pelayanan (ID: TRX-001)</h2>
                
                <div class="page-description">
                    <p><strong>Deskripsi:</strong> Ubah data pada formulir di bawah untuk memperbarui rincian transaksi **TRX-001**. Gunakan fitur ini dengan hati-hati.</p>
                </div>

                <div class="form-area">
                    <form action="/Kasir/KelolaTransaksiPelayanan" method="GET"> 
                        ...
                        <div class="form-group">
                            ...
                            <select id="produk">
                                ...
                                <option selected>Mainan Anjing</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="total" value="Rp 45.000" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-actions">
                            <a href="/Kasir/KelolaTransaksiPelayanan" class="btn-cancel">Batal</a>
