...
<head>
    ...
    <title>Hapus Data Transaksi Pelayanan</title>
    <style>
        ...
        <div class="main-container">
            ...
            <div class="content">
                ...
                <div class="confirmation-area">
                    ...
                    <form action="/Kasir/KelolaTransaksiPelayanan" method="POST">
                        @csrf
                        <div class="delete-actions">
                            <button type="submit" class="btn-delete-confirm">Ya, Hapus Sekarang</button>
                            <a href="/Kasir/KelolaTransaksiPelayanan" class="btn-cancel">Batal / Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
